...
export const AgentNodeShape = dia.Element.define('agentApp.AgentNode', {
  ...
  attrs: {
    ...
    errorCircle: { r: 10, cx: 258, cy: 24, fill: ERROR_COLOR, visibility: 'hidden' },
    errorBang: { text: '!', x: 258, y: 29, textAnchor: 'middle', fill: '#FFFFFF', fontFamily: FONT_FAMILY, fontSize: 13, fontWeight: '700', visibility: 'hidden' },
  },
  markup: [
