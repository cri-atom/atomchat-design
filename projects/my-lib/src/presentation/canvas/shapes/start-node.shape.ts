...
export const StartNodeShape = dia.Element.define('agentApp.StartNode', {
  ...
  attrs: {
    ...
    icon: { d: ICONS.fin, stroke: 'none', fill: TEXT_MUTED, refX: 8, refY: 6, transform: 'scale(0.027)' },
    ...
    addButtonIcon: { d: ICONS.plus, stroke: 'none', fill: TEXT_SECONDARY, refX: '50%', refDy: 8, transform: 'translate(-5, 6) scale(0.023)', pointerEvents: 'none' },
  },
  markup: [
