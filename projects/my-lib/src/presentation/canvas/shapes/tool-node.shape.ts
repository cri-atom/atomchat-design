...
export const ToolNodeShape = dia.Element.define('agentApp.ToolNode', {
  ...
  attrs: {
    ...
    icon: { d: ICONS.wrench, fill: TEXT_MUTED, refX: 14, refY: 14, transform: 'scale(0.6)' },
    ...
    addButtonIcon: { d: ICONS.plus, fill: TEXT_LIGHT, refX: '50%', refDy: 12, transform: 'scale(0.4) translate(-15,-15)', pointerEvents: 'none' },
